    ...
    <div id="wider-part" class="flex flex-grow h-2/3 border-b-2 border-stone-400/10 dark:border-stone-100/10">
      {#if currentPage}
        ...
        <div id="user" class="flex flex-row ml-auto mt-auto mb-auto space-x-4">
          {#if is_authenticated}
          <a href="https://t.me/noxlovette" title="text me" class=" hover:text-amber-400 transition-all">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <a href="/profile" class="hover:text-amber-400 transition-all" >
            ...
            <button on:click={logout} class="hover:text-amber-400 transition-all" >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
