  ...
  <ul class="flex items-center space-x-4 ">
    <li class="">
      <a href="https://twitter.com/BCF_app">
        <svg width="18" height="18" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg" class="hover:text-amber-300 transition-all hover:scale-110 active:scale-90">
    ...
    <li>
      <a
        ...
        class=""
      >
      <svg width="18" height="18" viewBox="0 0 1080 1080" xmlns="http://www.w3.org/2000/svg" class="hover:text-amber-300 transition-all hover:scale-110 active:scale-90">
    ...
    <li>
      ...
      >
        ...
        <svg width="20" height="20" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" class="hover:text-amber-300 transition-all hover:scale-110 active:scale-90">
        ...
        <li class="relative">
            ...
            {#if legalOn}
                <div class="absolute right-0 bottom-full mb-2 flex flex-col p-2 space-y-2 bg-stone-50 dark:bg-stone-800 shadow-lg rounded-lg"
                     in:fade>
                    <li>
                        <a href="/paperwork/privacy-policy" class="hover:text-amber-300 transition-all"> privacy policy </a>
                    </li>
                    <li>
                        <a href="/paperwork/terms-of-service" class="hover:text-amber-300 transition-all"> terms of use </a>
                    </li>
                </div>
            {/if}
        </li>
