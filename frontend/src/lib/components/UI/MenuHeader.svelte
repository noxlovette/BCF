...
<button
  class="fixed inset-0 z-40 bg-stone-900 bg-opacity-80 backdrop-blur-lg transition-all duration-300 ease-in-out md:hidden {isOpen
...
<div class="flex md:hidden">
  <button
    ...
    class="rounded-lg bg-stone-300 px-4 py-2 transition-colors duration-300 hover:bg-gold-400 dark:bg-stone-800 dark:hover:text-stone-800"
  >
    <Menu class="size-8" />
  </button>
  ...
  <div
    ...
    bg-stone-300 px-8 py-12 shadow-lg
    
    transition-transform duration-300 ease-in-out dark:bg-stone-900 {isOpen
    ...
    <nav class="space-y-8">
      <ul class="flex flex-col space-y-2">
        <a
          ...
          class="block rounded bg-stone-700 p-2 text-xl text-stone-100 transition-colors hover:bg-gold-400 hover:text-stone-800"
          >Browse</a
        >
