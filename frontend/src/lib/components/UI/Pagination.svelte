...
<div
  id="pagination"
  class="flex w-[80px] items-center justify-between rounded-full transition-colors border border-gold-400 dark:border-gold-900 bg-gold-700 p-2 text-gold-50 shadow hover:bg-white hover:text-gold-700 active:shadow-none dark:hover:bg-stone-800 dark:hover:text-stone-50
      "
>
