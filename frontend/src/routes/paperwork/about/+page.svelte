...
const bigText = `About<span class="text-amber-300">.</span>`;
...
<div class="mx-auto grid max-w-4xl grid-cols-1 items-start gap-8 px-4 pb-12 sm:px-6 lg:grid lg:gap-x-8 lg:px-8 xl:grid-cols-2 xl:gap-x-24 xl:gap-y-12 py-8 md:py-16 lg:py-24 text-pretty">
<Section sectionBigText={sectionBigTextWhat} sectionSmallText={sectionSmallTextWhat} />
<Section sectionBigText={sectionBigTextWhy} sectionSmallText={sectionSmallTextWhy} />

<Section sectionBigText={sectionBigTextFor} sectionSmallText={sectionSmallTextFor} />
<Section sectionBigText={sectionBigTextNext} sectionSmallText={sectionSmallTextNext} />


</div>
<BigText text="Together, we'll shape <span class='text-amber-300'>the future </span> of perfume-making<span class='text-amber-300'>.</span>"/>
</div>