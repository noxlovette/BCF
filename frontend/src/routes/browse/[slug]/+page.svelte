<script lang="ts">
  ...
  let volatility = ingredient.volatility || 'volatile';
...
<AppWrap class="2xl:px-24 select-text caret-navy-800 selection:bg-navy-100 selection:text-navy-800">
  <div class="border rounded-lg border-navy-800">
  <div id="top-part" class="flex flex-row items-center p-8 rounded-t-lg bg-navy-700 text-navy-50 border-b border-navy-800">
    <div id="top-left" class="flex w-3/4 flex-col space-y-2 ">
      <h1 class="flex w-full text-4xl font-bold tracking-tighter font-space">
