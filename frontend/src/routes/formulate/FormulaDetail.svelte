...
<div id="description-etc" class="flex flex-col mr-auto w-1/4 p-8 h-full divide-y-8 divide-amber-800/60 dark:divide-amber-50/60 space-y-4 bg-amber-50/80 dark:bg-amber-800/20 rounded-lg shadow">
    <div>
      ...
      <div id = "controls" class="pt-4">
        <button class=" hover:text-lime-800/70 dark:hover:text-lime-300/60 transition-all hover:scale-110" on:mousedown={() => editFormula(formulaDetail)} title="edit the formula">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
          </svg>
          </button>
          <button class=" hover:text-lime-800/70 dark:hover:text-lime-300/60 transition-all hover:scale-110" on:mousedown={() => handleDeleteFormula(formulaDetail.id)} title="delete the formula">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
            </svg>
          </button>
          <button class=" hover:text-lime-700/80 dark:hover:text-lime-300/60 transition-all hover:scale-110" on:mousedown={() => handleAddAsCustom(formulaDetail)} title="add the formula to collection as ingredient">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  <table id="formula-ingredient-table" class="table-fixed lowercase text-left w-full">
    <thead>
      <tr class="2">
        <th class="w-1/12">#</th>
        <th class="w-1/3 cursor-pointer hover:text-amber-700/90 active:translate-y-1 transition-all" on:mousedown={() => handleSort('ingredient')}>
      ...
      <th class="w-1/6 cursor-pointer hover:text-amber-700/90 active:translate-y-1 transition-all" on:mousedown={() => handleSort('volatility')}> 
        <div class="flex items-center">
        Volatility 
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 ml-1">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
      ...
      <th class="w-1/6 cursor-pointer hover:text-amber-700/90 active:translate-y-1 transition-all" on:mousedown={() => handleSort('amount')}> 
        <div class="flex items-center">
        Amount 
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 ml-1">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
