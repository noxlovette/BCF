...
<div class="relative">
  <input
    type="text"
    class="flex w-5/6 dark:bg-lime-800 p-0 focus:ring-0 text-lime-700 rounded-lg border-none"
  ...
  >
    {#each filteredCollection as item (item.common_name)}
      <button
        class="dropdown-item dark:bg-lime-800 p-2 hover:bg-lime-700 focus:ring-0 rounded-lg border-none w-full text-left"
