...
function fetchIngredients() {
    fetch(`http://localhost:8000/browse/api/ingredients?page=${currentPage}`)
        ...
        .then(data => {
            ...
            data.forEach(ingredient => {
                ...
                addButton.className = 'btn btn-primary add-to-collect';
                addButton.textContent = 'Add to collect';
                ...
                addButton.addEventListener('click', function() {
                    ...
                    // to add the ingredient to the user's collect
                    fetch(`http://localhost:8000/collection/add_to_collection`, {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            alert('Ingredient added to collect!');
                        } else {
                            alert('Failed to add ingredient to collect.');
                        }
                    })
                    .catch(error => {
                        alert("The ingredient is already in your collect.");
                    });
                });
