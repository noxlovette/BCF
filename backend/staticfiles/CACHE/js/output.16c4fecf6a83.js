...
inputElement.id=`${cellId}-input`;cell.innerHTML=inputElement;console.log('cellId after conversion',cell.id)});const saveButton=createButton('Save','save',saveIngredient,id);const cancelButton=createButton('Cancel','cancel',fetchIngredients);const buttonCell=row.querySelector('.editing');buttonCell.appendChild(saveButton);buttonCell.appendChild(cancelButton);}
