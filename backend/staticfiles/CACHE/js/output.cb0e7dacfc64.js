...
function editCollectionIngredient(event,id){const row=event.target.parentNode.parentNode;row.dataset.id=id;console.log('row id after assignment, edit button',row.id)
