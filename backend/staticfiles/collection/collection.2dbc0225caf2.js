...
function editCustomCollectionIngredient(customCollectionIngredientId) {
    console.log('Editing custom collect ingredient:', customCollectionIngredientId);
}
...
function saveIngredient(event) {
    ...
    const isCollectionInput = $('#is-collect-input');
            ...
            ingredients.forEach(collection_ingredient => {
                ...
                deleteIngredientButton.on('click', function() {
                    ...
                    if (type === 'CollectionIngredient') {
                        deleteCollectionIngredient(collection_ingredient.id, userId);
                    } else if (type === 'CustomCollectionIngredient') {
                        deleteCustomCollectionIngredient(collection_ingredient.id, userId);
                    }
                });
                ...
                editIngredientButton.on('click', function() {
                    let type = $(this).data('type');
                    if (type === 'CollectionIngredient') {
                        editCollectionIngredient(collection_ingredient.id);
                    } else if (type === 'CustomCollectionIngredient') {
                        editCustomCollectionIngredient(collection_ingredient.id);
                    }
});
...
function createCustomIngredient() {
    ...
    $('.done').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('.table-wrapper.collect').remove('.btn-create-ingredient');
                fetchIngredients();
            },
            error: function(error) {
