...
return response.json();}).then(data=>{totalPages=data.total_pages;const fragment=document.createDocumentFragment();data.ingredients.forEach(ingredient=>{const row=document.createElement('tr');row.innerHTML=`
                    <td>
