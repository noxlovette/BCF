...
return response.json();}).then(data=>{console.log(data);totalPages=data.total_pages;const fragment=document.createDocumentFragment();data.forEach(ingredient=>{const row=document.createElement('tr');row.innerHTML=`
                    <td>
