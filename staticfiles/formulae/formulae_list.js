    ...
    $.ajax({
        ...
        success: function(data, textStatus, xhr) {
            ...
            data.forEach(function(formula) {
                ...
                var editButton = $('<button class= "btn btn-primary btn-formula" id = "edit-formula">').text('Edit Formula');

                // Append the elements to the block
                formulaItem.append(nameLabel, timeEditedLabel, viewButton, editButton);
